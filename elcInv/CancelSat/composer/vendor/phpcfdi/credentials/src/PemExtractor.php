...
class PemExtractor
{
    ...
    public function extractPrivateKey()
    {
    ...
    protected function extractBase64($type)
    {
        $matches = [];
        ...
        //return $this->normalizeLineEndings(strval($matches[0] ?? '')); ->Erick
     ...
     * @internal
     */
    protected function normalizeLineEndings($content)
    {
        // move '\r\n' or '\n' to PHP_EOL
        // first substitution '\r\n' -> '\n'
        // second substitution '\n' -> PHP_EOL
