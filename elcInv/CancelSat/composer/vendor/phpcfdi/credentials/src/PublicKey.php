...
//use const PHP_VERSION_ID; ->Erick
use PHP_VERSION_ID;
...
class PublicKey extends Key
{
    ...
    public function verify($data, $signature, $algorithm = OPENSSL_ALGO_SHA256)
    {
        return $this->callOnPublicKey(
            function ($publicKey) use ($data, $signature, $algorithm) {
     ...
     * @return int
     */
    protected function openSslVerify($data, $signature, $publicKey, $algorithm)
    {
     ...
     * @return mixed
     */
    public function callOnPublicKey($function)
    {
     ...
     */
    private static function callOnPublicKeyWithContents($function, $publicKeyContents)
    {
