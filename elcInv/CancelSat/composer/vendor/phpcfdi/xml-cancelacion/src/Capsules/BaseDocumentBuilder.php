...
class BaseDocumentBuilder
{
     ...
     */
    public function __construct($extraNamespaces = null)
    {
    ...
    public function extraNamespaces()
    {
     ...
     * @return array<string| string>
     */
    public static function defaultExtraNamespaces()
    {
        return [
    ...
    public function createBaseDocument($tagName, $namespace)
    {
