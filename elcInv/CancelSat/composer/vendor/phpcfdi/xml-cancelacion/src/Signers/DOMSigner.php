...
class DOMSigner implements SignerInterface
{
     ...
     * @return DOMElement
     */
    private function rootElement($document)
    {
    ...
    public function getDigestSource()
    {
    ...
    public function getSignedInfoSource()
    {
        return $this->signedInfoSource;
    }

    public function getSignedInfoValue()
    {
        return $this->signedInfoValue;
    }

    public function signDocument($document, $credentials)
    {
    ...
    protected function createSignedInfoElement()
    {
        $template = '<SignedInfo>
