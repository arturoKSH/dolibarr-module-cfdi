...
abstract class Enum
{
     ...
     */
    protected static function overrideIndices()
    {
        return [];
    }

    final protected static function currentEntries()
    {
        /*
    ...
    final protected static function createEntries()
    {
    ...
    final protected static function parentEntries()
    {
