...
/**
 * \file    test/phpunit/CfdiFunctionalTest.php
 * \ingroup cfdi
 ...
 * @package Testcfdi
 */
class CfdiFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 500300; // TODO: autodetect?
	...
	{
		$this->url('/custom/cfdi/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('cfdi/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/cfdi/admin/about.php');
		$this->authenticate();
		return $this->assertContains('cfdi/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('cfdiwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCfdi_CfdiTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCfdi_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
